...
class SnakeEnv(gym.Env):
    REWARD_APPLE, REWARD_STEP, REWARD_LOOP_PENALTY = 50.0, -0.05, -0.25
    REWARD_COMPLETE, REWARD_DEATH_WALL, REWARD_DEATH_SELF = 100.0, -10.0, -10.0
    REWARD_SHAPING_CLOSER, REWARD_SHAPING_FURTHER = 0.05, -0.05
